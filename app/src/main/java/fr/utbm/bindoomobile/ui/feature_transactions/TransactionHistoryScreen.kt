...
import fr.utbm.bindoomobile.ui.components.error.ErrorListItem
import fr.utbm.bindoomobile.ui.components.pages.Page
import fr.utbm.bindoomobile.ui.components.pages.PagerTabRow
import fr.utbm.bindoomobile.ui.core.error.asUiTextError
import fr.utbm.bindoomobile.ui.feature_transactions.components.TransactionCard
...
private fun TransactionHistoryScreen_Ui(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        val pages: List<Page<Int>> = listOf(
            ...
            Page(1, title = stringResource(id = R.string.withdrawal)),
            Page(2, title = stringResource(id = R.string.deposit)),
