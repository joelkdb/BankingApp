...
import fr.utbm.bindoomobile.ui.components.forms.DecoratedFormField
import fr.utbm.bindoomobile.ui.components.forms.DecoratedPasswordFormField
import fr.utbm.bindoomobile.ui.components.snackbar.SnackBarMode
import fr.utbm.bindoomobile.ui.components.text_display.SpannableText
...
import fr.utbm.bindoomobile.ui.theme.Gray30
            ...
            onValueChange = {
                onIntent.invoke(
                    LoginIntent.LoginFieldChanged(
                        fieldType = LoginFieldType.USERNAME,
                        fieldValue = it
                    )
                )
            },
    ...
    Row(
        ...
        Image(
            modifier = Modifier
                .height(110.dp)
                .offset(x = (-56).dp),
            painter = painterResource(id = R.drawable.ic_bindoo_icon),
            contentDescription = null,
            colorFilter = ColorFilter.tint(Color(0xFFF4F2F2)),
        )
